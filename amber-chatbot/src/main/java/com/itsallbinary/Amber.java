...
import com.itsallbinary.obrada_ulaznog_teksta.DetektorRecenica;
import com.itsallbinary.obrada_ulaznog_teksta.Lematizator;
import com.itsallbinary.obrada_ulaznog_teksta.POS_Tagger;
import com.itsallbinary.obrada_ulaznog_teksta.Tokenizer;
...
public class Amber {
	...
	static {
		...
		pitanjeOdgovor.put("J", Arrays.asList("Price of all my wares is $6.99. Best on the market!",
	...
	public static void main(String[] args) throws FileNotFoundException, IOException, InterruptedException {
		...
		while (true) {
			...
			// Program u petlji obrađuje rečenisu po rečenicu
